package Box2D.Dynamics
{
   ...
   public class b2Island
   {
      ...
      public function Solve(param1:b2TimeStep, param2:b2Vec2, param3:Boolean, param4:Boolean) : void
      {
         ...
         {
            if(!(_loc6_ = m_bodies[_loc5_]).IsStatic())
            {
         ...
         (_loc8_ = new b2ContactSolver(param1,m_contacts,m_contactCount,m_allocator)).InitVelocityConstraints(param1);
         _loc5_ = 0;
         while(_loc5_ < m_jointCount)
         {
            (_loc7_ = m_joints[_loc5_]).InitVelocityConstraints(param1);
            _loc5_++;
         }
         _loc5_ = 0;
         while(_loc5_ < param1.maxIterations)
         {
            ...
            {
               (_loc7_ = m_joints[_loc9_]).SolveVelocityConstraints(param1);
               _loc9_++;
            }
            _loc5_++;
         }
         ...
         if(param3)
         {
            ...
            while(_loc5_ < m_jointCount)
            {
               (_loc7_ = m_joints[_loc5_]).InitPositionConstraints();
               _loc5_++;
            }
            m_positionIterationCount = 0;
            while(m_positionIterationCount < param1.maxIterations)
            {
               ...
               while(_loc5_ < m_jointCount)
               {
                  _loc12_ = (_loc7_ = m_joints[_loc5_]).SolvePositionConstraints();
                  _loc11_ &&= _loc12_;
                  _loc5_++;
               }
               if(_loc10_ && _loc11_)
