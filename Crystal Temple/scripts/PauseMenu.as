package
{
   ...
   public class PauseMenu extends Sprite
   {
      ...
      public var endGameBtn:MovieClip;
      ...
      public function PauseMenu()
      {
         ...
         this.ResumeBtn.addEventListener(MouseEvent.MOUSE_DOWN,this.Show_Hide);
         ...
         this.playMoreBtn.addEventListener(MouseEvent.MOUSE_DOWN,this.moreGames);
         this.retryBtn.addEventListener(MouseEvent.MOUSE_OVER,this.OverSounder);
         this.ResumeBtn.addEventListener(MouseEvent.MOUSE_OVER,this.OverSounder);
         this.endGameBtn.addEventListener(MouseEvent.MOUSE_OVER,this.OverSounder);
         this.playMoreBtn.addEventListener(MouseEvent.MOUSE_OVER,this.OverSounder);
         this.retryBtn.addEventListener(MouseEvent.MOUSE_DOWN,this.ClickSounder);
         this.ResumeBtn.addEventListener(MouseEvent.MOUSE_DOWN,this.ClickSounder);
         this.endGameBtn.addEventListener(MouseEvent.MOUSE_DOWN,this.ClickSounder);
         this.playMoreBtn.addEventListener(MouseEvent.MOUSE_DOWN,this.ClickSounder);
      ...
      {
         (this.parent as Game).MoreGames(param1);
      }
