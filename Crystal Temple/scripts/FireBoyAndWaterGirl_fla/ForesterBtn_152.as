package FireBoyAndWaterGirl_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="FireBoyAndWaterGirl_fla.ForesterBtn_152")]
   public dynamic class ForesterBtn_152 extends MovieClip
   {
      ...
      public function ForesterBtn_152()
      {
         super();
      ...
      internal function frame1() : *
      {
         ...
         this.txt.text = this.bm.getLocalizedString("menu_forest");
