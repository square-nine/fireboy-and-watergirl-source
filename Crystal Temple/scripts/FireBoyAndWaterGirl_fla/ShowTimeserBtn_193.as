package FireBoyAndWaterGirl_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="FireBoyAndWaterGirl_fla.ShowTimeserBtn_193")]
   public dynamic class ShowTimeserBtn_193 extends MovieClip
   {
      ...
      public function ShowTimeserBtn_193()
      {
         super();
      ...
      internal function frame1() : *
      {
         ...
         this.txt.text = this.bm.getLocalizedString("levelselect_showTimes");
