package FireBoyAndWaterGirl_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="FireBoyAndWaterGirl_fla.RetrierBtn_109")]
   public dynamic class RetrierBtn_109 extends MovieClip
   {
      ...
      public function RetrierBtn_109()
      {
         super();
      ...
      internal function frame1() : *
      {
         ...
         this.txt.text = this.bm.getLocalizedString("pause_retryLevel");
