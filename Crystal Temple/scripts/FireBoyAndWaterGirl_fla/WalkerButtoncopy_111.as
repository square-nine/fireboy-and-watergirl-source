package FireBoyAndWaterGirl_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="FireBoyAndWaterGirl_fla.WalkerButtoncopy_111")]
   public dynamic class WalkerButtoncopy_111 extends MovieClip
   {
      ...
      public function WalkerButtoncopy_111()
      {
         super();
      ...
      internal function frame1() : *
      {
         ...
         this.txt2.visible = false;
         trace("WALKER HAS " + this.txt.text + " width: " + this.width);
