package FireBoyAndWaterGirl_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="FireBoyAndWaterGirl_fla.PlayButton_147")]
   public dynamic class PlayButton_147 extends MovieClip
   {
      ...
      public function PlayButton_147()
      {
         super();
      ...
      internal function frame1() : *
      {
         ...
         this.txt.text = this.bm.getLocalizedString("menu_play");
