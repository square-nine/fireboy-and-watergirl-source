package FireBoyAndWaterGirl_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="FireBoyAndWaterGirl_fla.ResumerBtn_225")]
   public dynamic class ResumerBtn_225 extends MovieClip
   {
      ...
      public function ResumerBtn_225()
      {
         super();
      ...
      internal function frame1() : *
      {
         ...
         this.txt.text = this.bm.getLocalizedString("pause_resume");
