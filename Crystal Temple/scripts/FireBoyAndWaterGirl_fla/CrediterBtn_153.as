package FireBoyAndWaterGirl_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="FireBoyAndWaterGirl_fla.CrediterBtn_153")]
   public dynamic class CrediterBtn_153 extends MovieClip
   {
      ...
      public function CrediterBtn_153()
      {
         super();
      ...
      internal function frame1() : *
      {
         ...
         this.txt.text = this.bm.getLocalizedString("menu_credits");
