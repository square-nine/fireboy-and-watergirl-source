package FireBoyAndWaterGirl_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="FireBoyAndWaterGirl_fla.LighterBtn_151")]
   public dynamic class LighterBtn_151 extends MovieClip
   {
      ...
      public function LighterBtn_151()
      {
         super();
      ...
      internal function frame1() : *
      {
         ...
         this.txt.text = this.bm.getLocalizedString("menu_light");
