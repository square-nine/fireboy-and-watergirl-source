package FireBoyAndWaterGirl_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="FireBoyAndWaterGirl_fla.ContinueBtn_244")]
   public dynamic class ContinueBtn_244 extends MovieClip
   {
      ...
      public function ContinueBtn_244()
      {
         super();
      ...
      internal function frame1() : *
      {
         ...
         this.txt.text = this.bm.getLocalizedString("score_continue");
