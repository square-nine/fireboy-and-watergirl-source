package FireBoyAndWaterGirl_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="FireBoyAndWaterGirl_fla.MainManuerBtn_110")]
   public dynamic class MainManuerBtn_110 extends MovieClip
   {
      ...
      public function MainManuerBtn_110()
      {
         super();
      ...
      internal function frame1() : *
      {
         ...
         this.txt.text = this.bm.getLocalizedString("pause_mainMenu");
