package FireBoyAndWaterGirl_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="FireBoyAndWaterGirl_fla.IcerBtn_150")]
   public dynamic class IcerBtn_150 extends MovieClip
   {
      ...
      internal function frame1() : *
      {
         ...
         this.txt.text = this.bm.getLocalizedString("menu_ice");
